...
const Navbar = async () => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full border-b b z-50 bg-[var(--background)]" style={{paddingTop: "env(safe-area-inset-top)",minHeight: `calc(4rem + env(safe-area-inset-top))`}} >
